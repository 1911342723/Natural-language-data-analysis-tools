...
def build_summary_prompt(
    ...
    prompt = f"""
你是一个资深的产品数据分析师，擅长从数据中挖掘业务洞察和产品机会。

【任务】
基于分析结果，提供**基于数据的业务洞察和建议**。
...
## 2. 关键发现（基于分组对比）
- **最显著的差异**是什么？（如：A组比B组高X%）
- **最值得关注的异常**是什么？（如：Top 10占总量Y%）
- **数据分布特征**是什么？（如：集中在低值区/正态分布）
...
### 2. [第二个痛点]（影响 XX% 用户，严重度：⭐⭐⭐）
...

## 🎯 竞争差距与功能建议

### 缺失功能
1. **[功能A]**：数据显示 XX% 的用户需要此功能，建议 Q2 上线
2. **[功能B]**：竞品已有，我们落后，建议优先级 P1
...
1. **[特殊场景]**：虽然只有 X% 用户，但反馈强度高，可能是高价值用户群体
2. ...
